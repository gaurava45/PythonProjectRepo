...
harry bhai lekin
bahut hi badia admi haiaiinaiiiiiiiiiiii'''
...
strwithphonenum = "phone no. 10 digit number +919134567890" \
                  "9 digit number +91913456789" \
                  "not starting with 91   213919134567890"

# patt = re.compile(r'\b(91\d{10})')
patt = re.compile(r'\b91\d{10}')

matches = patt.finditer(strwithphonenum)
for match in matches:
    print(match)
